...
public final class UiComponents {
    ...
    public static void loadFonts() {
        Font.loadFont(UiComponents.class.getResourceAsStream("/fonts/Outfit-Regular.ttf"), 12);
        Font.loadFont(UiComponents.class.getResourceAsStream("/fonts/Outfit-Thin.ttf"), 12);
        Font.loadFont(UiComponents.class.getResourceAsStream("/fonts/Outfit-Medium.ttf"), 12);
        Font.loadFont(UiComponents.class.getResourceAsStream("/fonts/Outfit-Light.ttf"), 12);
    }
